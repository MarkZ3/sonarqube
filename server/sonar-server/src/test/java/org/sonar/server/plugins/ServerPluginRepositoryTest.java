...
public class ServerPluginRepositoryTest {
  ...
  @Test
  public void fail_when_devcockpit_is_installed() throws Exception {
    copyTestPluginTo("fake-devcockpit-plugin", fs.getInstalledPluginsDir());

    thrown.expect(MessageException.class);
    thrown.expectMessage("Plugin 'devcockpit' is no more compatible with this version of SonarQube");
    underTest.start();
  }
